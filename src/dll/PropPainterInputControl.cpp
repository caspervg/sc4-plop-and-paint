...
namespace {
    ...
    void PopulatePreviewBounds(PropPaintOverlay::PreviewPlacement& pp, const Prop& prop) {
        pp.width  = prop.width;
...
void PropPainterInputControl::PopulatePreviewBounds_(PropPaintOverlay::PreviewPlacement& placement,
